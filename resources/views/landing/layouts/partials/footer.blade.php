<footer class="footer-main bg-gradient-primary overlay-shape-06 dark">
    <div class="padding">
        <div class="center margin-bottom max-width-m">
            <h3>Grow your startup the right way.</h3>
            <p class="paragraph">Our tools are packed with epic features. So you can focus on your most important
                work.</p>
        </div>
        ...
        <div class="card card-content margin-bottom max-width-l dark">
        ...
        <div class="row center-desktop max-width-l">
            <div class="col-two-fifths">
                <h6>Opalin ®</h6>
                <p>We're a completely remote company, working across twenty countries with over 20,000 customers.
                </p>
            </div>
    ...
    <p class="copyright"><span>HTML Template by </span><a href="https://uiuxassets.com/" target="_blank">UI/UX
            Assets</a><span> - © 2018, all rights reserved.</span></p>
</footer>