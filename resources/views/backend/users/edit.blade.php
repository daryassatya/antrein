...
@section('content')
    <div class="col-lg-12 col-12">
        <div class="box">
            ...
            <form class="form" action="{{ route('backend.user.update', $user->username) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('patch')
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group @error('image') error @enderror">
                                ...
                                <img class="img-fluid mb-3 col-sm-5" src="{{ asset('user/image/' . $user->image) }}" width="100px;">
                            ...
                            <div class="form-group @error('password_confirmation') error @enderror">
                                ...
                                <input type="password_confirmation" class="form-control" placeholder="Confirm Password" name="password_confirmation" id="password_confirmation"
                                    value="">
