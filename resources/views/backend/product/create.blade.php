...
@section('content')
    <div class="col-lg-12 col-12">
        <div class="box">
            ...
            <form class="form" action="{{ route('backend.product.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group @error('prod_id') error @enderror">
                                ...
                                <input type="text" class="form-control" placeholder="Product ID" name="prod_id" id="prod_id"
                                    value="{{ old('prod_id') }}">
                            ...
                            <div class="form-group @error('price') error @enderror">
                                ...
                                <input type="number" min="1" name="price" id="" class="form-control" placeholder="Minimum Price Rp. 1" step="0.1" value="{{ old('price') }}">
