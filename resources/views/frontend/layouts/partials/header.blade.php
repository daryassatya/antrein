<header class="header-main dark" id="header-nav">
    <nav>
        <a href="{{ route('/') }}" class="logo" rel="home"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <path
                    ...
                    fill="currentColor" />
            </svg><span>AntreIn</span></a>
        <div class="nav-toggle"></div>
        <ul class="inline">
            <li><a href="{{ route('/') }}" class="active">Beranda</a></li>
            <li><a href="{{ route('paket-layanan') }}">Paket Layanan</a></li>
